...
describe("ユーティリティ関数", () => {
  ...
  describe("truncateText", () => {
    ...
    it("最大長を超えるテキストを切り詰める", () => {
      expect(truncateText("これは非常に長いテキストです", 10)).toBe(
        "これは非常に長いテキ...",
      );
    });
  ...
  describe("stripHtmlTags", () => {
    it("HTMLタグを除去する", () => {
      ...
      expect(stripHtmlTags("<div><span>ネストされた</span>タグ</div>")).toBe(
        "ネストされたタグ",
      );
    });
  ...
  describe("toKebabCase", () => {
    ...
    it("混合形式を処理する", () => {
      expect(toKebabCase("someVery Complex_string")).toBe(
        "some-very-complex-string",
      );
    });
  });
  ...
  describe("safeLog", () => {
    ...
    it("開発環境でログを出力する", () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        "[GitHub Search App] test message",
        undefined,
      );
    });
  ...
  describe("safeError", () => {
    ...
    it("開発環境でエラーログを出力する", () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        "[GitHub Search App Error] error message",
        undefined,
      );
    });
