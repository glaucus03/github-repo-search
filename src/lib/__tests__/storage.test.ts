  ...
  describe('LocalStorageManager', () => {
    describe('getItem', () => {
      ...
      it('JSON解析エラー時にデフォルト値を返す', () => {
        ...
        const defaultValue = { default: true }
        const result = LocalStorageManager.getItem('invalid-json', defaultValue)
    ...
    describe('setItem', () => {
      ...
      it('エラー時にfalseを返す', () => {
        ...
        const success = LocalStorageManager.setItem('test-key', { test: 'value' })
      ...
      it('クライアント環境でない場合はfalseを返す', () => {
        ...
        const originalIsClient = (LocalStorageManager as any).isClient
  ...
  describe('SearchHistoryStorage', () => {
    describe('getHistory', () => {
      it('履歴を取得する', () => {
        ...
        mockLocalStorage.setItem(STORAGE_KEYS.SEARCH_HISTORY, JSON.stringify(history))
  ...
  describe('FavoritesStorage', () => {
    ...
    describe('getFavorites', () => {
      it('お気に入りを取得する', () => {
        ...
        mockLocalStorage.setItem(STORAGE_KEYS.FAVORITES, JSON.stringify(favorites))
    ...
    describe('addToFavorites', () => {
      ...
      it('最大数を超える追加を拒否する', () => {
        ...
        const success = FavoritesStorage.addToFavorites({ ...mockRepository, id: 999 })
  ...
  describe('UISettingsStorage', () => {
    ...
    describe('getSettings', () => {
      it('設定を取得する', () => {
        ...
        mockLocalStorage.setItem(STORAGE_KEYS.UI_SETTINGS, JSON.stringify(customSettings))
  ...
  describe('DataMigration', () => {
    ...
    describe('importData', () => {
      ...
      it('データを正しくインポートする', () => {
        ...
        expect(success).toBe(true)
        expect(SearchHistoryStorage.getHistory()).toEqual(['angular', 'svelte'])
