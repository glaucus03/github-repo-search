...
describe("search-domain", () => {
  ...
  describe("createRecentRepositoryQuery", () => {
    beforeEach(() => {
      ...
      jest.spyOn(Date.prototype, "setMonth").mockImplementation(function (
        this: Date,
        _month: number,
      ) {
      ...
      jest
        ...
        .mockReturnValue("2023-11-01T00:00:00.000Z");
    });
  ...
  describe("calculateSearchStatistics", () => {
    ...
    it("言語がnullの場合は「その他」に分類する", () => {
      const reposWithNull = [{ ...mockRepositories[0], language: null }];
