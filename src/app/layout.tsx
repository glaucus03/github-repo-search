...
import { Navigation, NotificationSystem, InitializationProvider, ErrorBoundary } from '@/components'
...
export const metadata: Metadata = {
  ...
  keywords: [
    'GitHub', 'Repository', 'Search', 'Development', 'Open Source', 'Programming',
    'Code', 'Developer Tools', 'Software Development', '開発', 'プログラミング',
    'ソフトウェア開発', 'オープンソース'
  ],
