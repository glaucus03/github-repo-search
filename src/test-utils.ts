...
import type { GitHubRepository, GitHubUser, GitHubRateLimit } from '@/types/github'
 ...
 */
export function createMockGitHubRepository(overrides: Partial<GitHubRepository> = {}): GitHubRepository {
  return {
    id: 1,
 ...
 */
export function createMockGitHubRateLimit(overrides: Partial<GitHubRateLimit> = {}): GitHubRateLimit {
  return {
    limit: 5000,
    remaining: 4999,
    reset: 1609459200,
 ...
 */
export function createMockErrorResponse(error: any, status = 404): Response {
